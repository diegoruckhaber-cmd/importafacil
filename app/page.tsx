...
function calc(s:any){
 ...
 const pis=cif*s.pis/100, cofins=cif*s.cofins/100, base=cif+ii+ipi+pis+cofins;
 const icms=s.icms>=100?0:(base*(s.icms/100))/(1-s.icms/100), total=base+s.otherBrl+icms;
...
export default function Home(){
 ...
 return <main>
  <header>
   ...
   <section className="wrap hero">
    <div><div className="eyebrow">PRÉ-ESTUDO DE IMPORTAÇÃO</div>
     ...
     <div className="heroActions"><a className="primary" href="#simulador">Simular gratuitamente</a><a className="ghost" href="/upgrade">Assinar PRO</a></div>
  ...
  <section className="wrap section" id="pro">
   <div className="sectionHead"><div><div className="eyebrow dark">PLANO PRO</div><h2>Quando importar deixa de ser uma aposta.</h2><p>R$ 29,90/mês. Cancele quando quiser.</p></div></div>
   <div className="priceGrid">
    <div className="priceCard"><small>GRÁTIS</small><h3>Para testar</h3><b>R$ 0</b><ul><li>Calculadora básica</li><li>Pré-estudo de custo</li><li>Preço mínimo estimado</li><li>Até 3 simulações salvas</li></ul><a className="secondaryBtn" href="#simulador">Começar grátis</a></div>
    <div className="priceCard featured"><div className="tag">PRO</div><small>PARA QUEM IMPORTA</small><h3>Decida com mais segurança</h3><b>R$ 29,90<em>/mês</em></b><ul><li>Histórico completo</li><li>Comparação de cenários</li><li>Relatórios profissionais</li><li>NCMs monitoradas</li><li>Indicadores de margem e ROI</li></ul><a className="secondaryBtn" href="/upgrade">Assinar PRO</a></div>
  ...
  <footer><div className="wrap"><b>ImportaFácil</b><span>© 2026 • MVP em lançamento</span></div></footer>
 </main>
}
