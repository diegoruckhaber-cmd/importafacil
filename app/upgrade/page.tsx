   ...
   <div style={{maxWidth:720,margin:"auto",background:"white",border:"1px solid #e5e5df",borderRadius:22,padding:42}}>
     ...
     {isPro?<>
       ...
       <div style={{display:"grid",gap:10}}>
         <button onClick={manageBilling} disabled={portalLoading||!ready} style={{width:"100%",padding:16,border:0,borderRadius:11,background:"#111",color:"white",fontSize:16,fontWeight:800,cursor:"pointer"}}>
           {portalLoading?"Abrindo portal...":"Gerenciar assinatura e cobrança"}
         </button>
         <a href="/dashboard" style={{display:"block",textAlign:"center",width:"100%",boxSizing:"border-box",padding:14,borderRadius:11,border:"1px solid #111",color:"#111",fontWeight:700,textDecoration:"none"}}>Ir para meu painel</a>
       </div>
