    ...
    const timer = window.setTimeout(async () => {
      try {
        ...
        if (data.applicable === true && next.length > 0 && !value) {
          const residual = next.find((option: Option) => option.exporter.toLowerCase() === "demais empresas");
