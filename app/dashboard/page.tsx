...
import { savedSimulationKind, savedSimulationStatus, savedSimulationTotal, type SavedSimulationRecord } from "../../lib/simulation-record";
...
const empty={background:"white",border:"1px solid #e5e5df",borderRadius:18,padding:40} as const;
const row={background:"white",border:"1px solid #e5e5df",borderRadius:16,padding:20,display:"flex",justifyContent:"space-between",gap:20,alignItems:"center"} as const;
const pill={fontSize:11,padding:"4px 7px",background:"#f0f0ec",borderRadius:999,color:"#555",fontWeight:700} as const;
