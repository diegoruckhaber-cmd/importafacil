import { resolveTTD409410OutputRate, type TTD409410OutputRateInput } from "./sc-ttd409-410-output-rate";
...
export function calculateTTD409410Benefit(input: TTD409410BenefitCalculationInput): TTD409410BenefitCalculation {
  if (!Number.isFinite(input.outputTaxBase) || input.outputTaxBase < 0) {
    throw new Error("outputTaxBase inválida");
  }
