...
export type ImportAdditionalChargesInput = {
  freightBrl: number;
...
export type ImportAdditionalChargesResult = {
  afrmmRate: number;
  afrmmBrl: number;
  siscomexBrl: number;
  warnings: string[];
...
/** Shared federal/import charges used by state import calculations. */
export function resolveImportAdditionalCharges(input: ImportAdditionalChargesInput): ImportAdditionalChargesResult {
