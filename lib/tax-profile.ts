...
/**
 * Creditability is intentionally separate from tax payment.
 * A tax paid at import is not automatically treated as an economic cost:
 * the actual credit depends on the taxpayer, goods, destination/use and
 * applicable legislation. Unknown cases return null rather than a guess.
 */
