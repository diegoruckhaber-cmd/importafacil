...
class ParserRegression(unittest.TestCase):
    ...
    def test_index_entries_come_only_from_active_table(self):
        ...
        <table>
          ...
          <tr><td><a href="/mdic/pt-br/assuntos/comercio-exterior/defesa-comercial-e-interesse-publico/medidas-em-vigor/medidas-em-vigor/laminados-planos-de-aco-ao-silicio-aco-gno">Aço GNO</a></td><td>Antidumping</td><td>China</td><td>2030</td></tr>
        </table>
        """
        ...
        self.assertTrue(any(entry["url"].endswith("/aco-gno") for entry in entries))
