...
assert.deepEqual(readiness.release.activeStateScope, ["ES", "SC", "SP"]);
...
console.log("Launch readiness: OK — all P0 evidence verified; controlled beta covers ES, SC and SP while national release remains scope-blocked");
