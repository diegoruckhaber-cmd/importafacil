...
assert.equal(keysChinaCalc.amountBrl, 13513.5);
...
assert.equal(keysColombia.amountBrl, 687.5);
...
assert.equal(keysPeruResidual.amountBrl, 4884);
...
assert.equal(padlocks.amountBrl, 5560.5);
...
assert.equal(petMalaysiaSpecific.amountBrl, 1335.4);
...
assert.equal(petMalaysiaResidual.amountBrl, 6407.5);
...
assert.equal(petVietnam.amountBrl, 8847.85);
